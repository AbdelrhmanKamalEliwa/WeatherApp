...
final class GetCurrentWeatherUseCase: GetCurrentWeatherUseCaseContract {
    ...
    init(
        repository: CurrentWeatherRepositoryContract = WeatherRepository(),
    ...
    func excute(
        ...
        return repository.getCurrentWeather(using: requestModel, forItem: isCurrentLocation ? .currentLocation : .coordinates)
    }
    ...
    func excute(
        ...
        return repository.getCurrentWeather(using: requestModel, forItem: searchItem)
    }
    ...
    func excute(
        ...
        case .success:
            ...
            return getCurrentWeatherByCurrentLocation(using: currentLocation, and: units)
...
private extension GetCurrentWeatherUseCase {
    func getCurrentWeatherByCurrentLocation(
        ...
        case .success(let coordinates):
            ...
            return repository.getCurrentWeather(using: requestModel, forItem: .currentLocation)
